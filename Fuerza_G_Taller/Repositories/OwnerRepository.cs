...
namespace Fuerza_G_Taller.Repositories
{
    public class OwnerRepository : IRepository<Owner>
    {
        ...
        public OwnerRepository(DatabaseConnectionManager connectionManager)
        {
        ...
        public void Add(Owner entity)
        {
            ...
            using var cmd = conn.CreateCommand();
            cmd.CommandText = @"INSERT INTO owner (name, first_last_name, second_last_name, phone_number, email, document_number, address) 
                                VALUES (@name, @first_last_name, @second_last_name, @phone_number, @email, @document_number, @address)";
